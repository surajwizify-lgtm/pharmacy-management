...
export default function SupplierDetailPage() {
    ...
    return (
        <div className="min-h-screen bg-neutral-50">
            <div className="max-w-5xl mx-auto px-6 py-8 print-area">
                ...
                <div className="bg-white border border-neutral-200 rounded-xl mb-6 shadow-sm overflow-hidden">
                    <div className="flex justify-between items-center px-6 py-4 border-b border-neutral-200">
                        ...
                        <Link href={`/purchase-orders/new?supplierId=${id}`} className="text-sm font-medium text-primary-600 hover:text-primary-700 no-print">
                            + New PO
                        </Link>
                    </div>
                        ...
                        <table className="w-full text-sm">
                            <thead>
                                <tr className="bg-neutral-50 text-neutral-500 text-xs uppercase tracking-wide">
                                    ...
                                    <th className="p-3 text-left font-medium no-print">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                ...
                <div className="bg-white border border-neutral-200 rounded-xl mb-6 shadow-sm overflow-hidden">
                    <div className="flex justify-between items-center px-6 py-4 border-b border-neutral-200">
                        ...
                        <Link href={`/supplier-returns/new?supplierId=${id}`} className="text-sm font-medium text-primary-600 hover:text-primary-700 no-print">
                            + New Return
                        </Link>
                    </div>
                ...
                <div className="bg-white border border-neutral-200 rounded-xl mb-8 shadow-sm overflow-hidden">
                    <div className="flex justify-between items-center px-6 py-4 border-b border-neutral-200">
                        ...
                        <button
                            ...
                            className="text-sm font-medium text-primary-600 hover:text-primary-700 no-print"
                        >
                            + Add Payment
                        </button>
                    </div>
            ...
            {/* Add Payment Modal */}
            {showPaymentModal && (
                <div className="fixed inset-0 bg-overlay-black backdrop-blur-sm flex items-center justify-center z-50 p-4 no-print">

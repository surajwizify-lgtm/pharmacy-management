...
// body: {
//   invoiceNumber, supplierId, purchaseOrderId?, isInterState,
//   items: [{ productId, batchNumber, manufactureDate?, expiryDate,
//             quantity, freeQuantity?, purchaseRate, mrp, sellingPrice,
//             discountPercent?, hsnCode, gstPercentage }]
// }
    ...
    try {
        const result = await prisma.$transaction(async (tx) => {
            ...
            for (const it of body.items) {
                // 1. Create the batch this line item receives stock into
                ...
                // 2. Compute this line's tax breakdown
                ...
                preparedItems.push({
                    ...
                    totalAmount,
                    batchId: batch.id,
                    // for invoice-level rollup below
                    _gross: gross,
            ...
            // 3. Roll up invoice-level totals from the line items
            ...
            // strip the temp rollup-only fields before nested create
            ...
            // 4. Push the GST INPUT entry — invoice is fully created, so
            //    invoice.totalGst etc. are properly in scope here.
            ...
            // 5. If this invoice fulfills a PO, mark it received

                    ...
                    <div className="w-full max-w-md overflow-hidden rounded-2xl bg-white shadow-2xl" onClick={(e) => e.stopPropagation()}>
                        <div className="flex items-center justify-between bg-gradient-to-r from-brand-600 to-brand-700 px-5 py-4 text-white">
                            <div className="flex items-center gap-2">
                                ...
                                <h2 className="text-base font-semibold">{mode === 'create' ? 'Add Doctor' : 'Edit Doctor'}</h2>
                            </div>
                        ...
                        <div className="space-y-3 p-5">
                            ...
                            <div>
                                ...
                                <input className="input" value={registrationNo} onChange={(e) => setRegistrationNo(e.target.value)} />
                            </div>
                            <div>

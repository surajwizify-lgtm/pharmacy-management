...
export default function NewSupplierReturnPage() {
    ...
    async function handleSubmit(e: FormEvent) {
        ...
        setSaving(true);
        try {
            const ret = await apiFetch<{ id: number }>('/api/supplier-returns', {
                method: 'POST',
                body: JSON.stringify({
                    supplierId,
            ...
            router.push(`/supplier-returns/${ret.id}`);
        } catch (err) {
    ...
    return (
        <div className="mx-auto max-w-3xl space-y-6">
            <div>
                <Link href="/supplier-returns" className="text-xs font-medium text-brand-600 hover:underline">
            ...
            <div className="flex justify-end gap-2">
                <Link href="/supplier-returns" className="btn-secondary">Cancel</Link>
